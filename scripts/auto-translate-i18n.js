...
async function translate(text, to) {
  try {
    ...
    console.log(`Translation failed: ${text}`);
    return text; // 失败则保留原文
  }
}
...
// 主逻辑
async function run() {
  console.log('Generating 26-language JSON files...\n');
  ...
  console.log('Created zh-CN.json (source language)\n');
  ...
  console.log('All done. JSON files written to src/i18n/');
}

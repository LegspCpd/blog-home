...
/**
 * 作者头像地址由调用方传入（见 utils/site-avatar）。
 * 这里**不能**自己拼 `${SITE_URL}/${profileConfig.avatar}`：
 * avatar 很可能是 src 相对路径（如 assets/images/ico.png），
 * 直接拼出来的 URL 在线上是 404（破图）。
 */

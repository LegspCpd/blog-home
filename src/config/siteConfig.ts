...
export const siteConfig: SiteConfig = {
	...
	// 站点描述
	description:
		"LegspCpd 的个人博客，记录我的学习和生活点滴,分享我的技术经验和见解。",
	...
	// 主题色
	// Supabase 设计仅使用单一 emerald 主色（#3ecf8e），因此锁定色相为 165 并固定选择器
	themeColor: {
		// 主题色的默认色相，范围从 0 到 360。165 对应 emerald 绿
		hue: 165,
		// Supabase 不使用多色相主题，隐藏主题色选择器
		fixed: true,
